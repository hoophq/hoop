...
(def connection-icons-rounded-dictionary
  {:postgres (str config/webapp-url "/icons/connections/postgres-rounded.svg")
   ...
   :ssh-local (str config/webapp-url "/icons/connections/custom-ssh.svg")
   ...
   :mcp (str config/webapp-url "/icons/connections/mcp-default.svg")
   :mcpproxy (str config/webapp-url "/icons/connections/mcp-default.svg")
