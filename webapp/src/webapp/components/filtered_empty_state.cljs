...
(defn filtered-empty-state
  "Reusable empty state component for filtered lists.
   ...
   - :message (string, optional) - Override the generated title text entirely
   - :subtitle (string, optional) - Override the generated subtitle text entirely
   - :docs-url (string, optional) - URL to documentation
   - :docs-label (string, optional) - Label for documentation link"
  [{:keys [entity-name entity-name-plural filter-name filter-value message subtitle docs-url docs-label]
