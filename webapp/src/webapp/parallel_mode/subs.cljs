...
(rf/reg-sub
 :parallel-mode/promotion-seen
 (fn [db _]
   (or (get-in db [:features :parallel-mode :promotion-seen] false)
       (boolean (.getItem (.-localStorage js/window) "parallel-mode-promotion-seen")))))
