...
// webapp/src/webapp/features/activation-journey/guardrail_templates.cljs — the
// CLJS activation journey still reads its own copy to render the suggestion
// cards, and it matches configured guardrails by name to decide card states, so
// the two catalogs must stay in sync until the journey itself is migrated.
//
// Contract:
// - `name` is the ?template= deep-link value the activation-journey cards send
//   to /guardrails/new, and is globally unique across subtypes.
// - Everything except `title` and `cardDescription` (UI-only card labels) is
//   already shaped like a POST /guardrails payload, so `input` and `output`
...
export const GUARDRAIL_TEMPLATES_BY_SUBTYPE = {
  'postgres': [
    {
      ...
      cardDescription: 'Blocks UPDATE and DELETE without WHERE clause',
    ...
    },
    {
      ...
      cardDescription: 'Blocks words like DROP TABLE, TRUNCATE, DROP DATABASE, DROP SCHEMA',
    ...
    },
    {
      ...
      cardDescription: 'Blocks filesystem-access function results',
  ...
  'mysql': [
    ...
    },
    {
      ...
      cardDescription: 'Blocks privilege and authentication changes',
    ...
    },
    {
      ...
      cardDescription: 'Blocks filesystem read/write via SQL',
  ...
  'mongodb': [
    {
      ...
      cardDescription: 'Blocks collection and database drops',
    ...
    },
    {
      ...
      cardDescription: 'Blocks updateMany/deleteMany with empty filter',
    ...
    },
    {
      ...
      cardDescription: 'Blocks server-side JavaScript execution',
  ...
  'dynamodb': [
    {
      ...
      cardDescription: 'Blocks table deletion API calls',
    ...
    },
    {
      ...
      cardDescription: 'Blocks Scan without FilterExpression',
    ...
    },
    {
      ...
      cardDescription: 'Blocks bulk deletes via BatchWriteItem',
  ...
  'oracledb': [
    ...
    },
    {
      ...
      cardDescription: 'Blocks SHUTDOWN, STARTUP, ALTER SYSTEM, ALTER DATABASE',
    ...
    },
    {
      ...
      cardDescription: 'Blocks filesystem and network UTL/DBMS packages',
  ...
  'mssql': [
    ...
    },
    {
      ...
      cardDescription: 'Blocks xp_cmdshell and OLE automation procs',
    ...
    },
    {
      ...
      cardDescription: 'Blocks BULK INSERT and OPENROWSET I/O',
  ...
  'cassandra': [
    {
      ...
      cardDescription: 'Blocks TRUNCATE and DROP statements',
    ...
    },
    {
      ...
      cardDescription: 'Blocks ALLOW FILTERING (full-cluster scan)',
    ...
    },
    {
      ...
      cardDescription: 'Blocks UNLOGGED BATCH (consistency risk)',
  ...
  'bigquery': [
    {
      ...
      cardDescription: 'Blocks dataset/table removal',
      name: 'bq-block-drop',
    ...
    {
      title: 'Require LIMIT',
      cardDescription: 'Blocks unbounded SELECT (cost control)',
    ...
    },
    {
      ...
      cardDescription: 'Blocks EXPORT DATA and external table creation',
  ...
  'redis': [
    {
      ...
      cardDescription: 'Blocks flush, debug, and shutdown commands',
    ...
    },
    {
      ...
      cardDescription: 'Blocks live CONFIG and ACL changes',
    ...
    {
      title: 'Block KEYS *',
      cardDescription: 'Blocks blocking KEYS * scan',
  ...
  'claude-code': [
    {
      ...
      cardDescription: 'Blocks destructive/piped-shell prompt patterns',
    ...
    },
    {
      ...
      cardDescription: 'Redacts SSN/email/PAN in model output',
    ...
    },
    {
      ...
      cardDescription: 'Blocks common prompt-injection phrases',
  ...
  'aws-cli': [
    {
      ...
      cardDescription: 'Blocks IAM identity/policy mutations',
    ...
    },
    {
      ...
      cardDescription: 'Blocks resource teardown commands',
    ...
    },
    {
      ...
      cardDescription: 'Redacts access keys in output',
  ...
  'kubernetes': [
    {
      ...
      cardDescription: 'Blocks cluster-wide deletes',
    ...
    },
    {
      ...
      cardDescription: 'Blocks interactive shells into pods',
    ...
    },
    {
      ...
      cardDescription: 'Redacts Secret data fields in output',
  ...
  'kubernetes-eks': [
    {
      ...
      cardDescription: 'Blocks cluster lifecycle changes',
    ...
    },
    {
      ...
      cardDescription: 'Blocks edits to aws-auth ConfigMap',
    ...
    },
    {
      ...
      cardDescription: 'Blocks ClusterRoleBinding creation (escalation)',
  ...
  'git': [
    {
      ...
      cardDescription: 'Blocks force push (history rewrite)',
    ...
    },
    {
      ...
      cardDescription: 'Blocks history-rewriting tooling',
    ...
    },
    {
      ...
      cardDescription: 'Blocks credential helper tampering',
  ...
  'github': [
    {
      ...
      cardDescription: 'Blocks repo deletion and archival',
      ...
      input: {
        rules: [
          {
            type: 'deny_words_list',
            words: ['gh repo delete', 'gh repo archive', 'repos/.+ -X DELETE'],
            pattern_regex: '',
          },
        ],
      },
    ...
    },
    {
      ...
      cardDescription: 'Blocks Actions secrets changes',
    ...
    },
    {
      ...
      cardDescription: 'Blocks org/team membership API mutations',
  ...
  'web-application': [
    {
      ...
      cardDescription: 'Blocks DELETE/PURGE requests',
    ...
    },
    {
      ...
      cardDescription: 'Blocks admin/debug endpoint paths',
    ...
    },
    {
      ...
      cardDescription: 'Redacts bearer tokens and API keys in responses',
  ...
  'ruby-on-rails': [
    {
      ...
      cardDescription: 'Blocks mass-mutation methods',
    ...
    },
    {
      ...
      cardDescription: 'Blocks shell-out from console',
    ...
    },
    {
      ...
      cardDescription: 'Blocks credential and secret reads',
  ...
  'python': [
    {
      title: 'Block shell exec',
      cardDescription: 'Blocks shell exec',
      name: 'py-block-shell',
    ...
    },
    {
      ...
      cardDescription: 'Blocks outbound HTTP and socket connections',
    ...
    },
    {
      ...
      cardDescription: 'Blocks dynamic code execution',
      name: 'py-block-eval',
  ...
  'php-artisan': [
    {
      ...
      cardDescription: 'Blocks schema-wipe migrations',
    ...
    },
    {
      ...
      cardDescription: 'Blocks PHP shell exec functions',
    ...
    },
    {
      ...
      cardDescription: 'Blocks app-key and env mutations',
  ...
  'elixir': [
    {
      ...
      cardDescription: 'Blocks OS command execution',
    ...
    },
    {
      ...
      cardDescription: 'Blocks node and application shutdown',
    ...
    },
    {
      ...
      cardDescription: 'Blocks mass Ecto mutations',
  ...
  'clojure': [
    {
      ...
      cardDescription: 'Blocks clojure.java.shell calls',
    ...
    },
    {
      ...
      cardDescription: 'Blocks dynamic code loading',
    ...
    },
    {
      ...
      cardDescription: 'Blocks JVM shutdown',
  ...
  'nodejs': [
    {
      ...
      cardDescription: 'Blocks child_process spawns',
    ...
    },
    {
      ...
      cardDescription: 'Blocks filesystem mutations',
  ...
  'ssh': [
    {
      title: 'Block rm -rf',
      cardDescription: 'Blocks recursive root/home deletes',
    ...
    },
    {
      ...
      cardDescription: 'Blocks privilege escalation',
    ...
    },
    {
      ...
      cardDescription: 'Blocks curl|sh and wget|sh install patterns',
  ...
  'rdp': [
    {
      ...
      cardDescription: 'Blocks disk wipe commands',
    ...
    },
    {
      ...
      cardDescription: 'Blocks local user/admin changes',
    ...
    },
    {
      ...
      cardDescription: 'Blocks Defender/security control bypass',
...
export function findGuardrailTemplate(name) {
  if (!name) return null
  for (const templates of Object.values(GUARDRAIL_TEMPLATES_BY_SUBTYPE)) {
