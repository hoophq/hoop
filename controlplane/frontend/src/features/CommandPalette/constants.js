...
export const SUGGESTION_ITEMS = [
  { id: 'sidecars', label: 'Sidecars', description: 'Connected sidecars and their resources', icon: Container, path: '/sidecars', adminOnly: true },
  { id: 'reviews', label: 'Reviews', description: 'Pending approvals', icon: Signature, path: '/reviews', adminOnly: true, allowApprover: true },
]
