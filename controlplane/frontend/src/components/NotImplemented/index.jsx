 ...
 *
 * The control plane IA is defined ahead of the gateway conversion on purpose, so that
 * every project in the initiative has a place to land instead of inventing its own
 * surface. This is that place, and until a project fills it, it says which one owes
 * the work and what is missing.
 *
 * It renders nothing that could be mistaken for real state: no empty table, no zero
 * counter, no spinner that never resolves. A page that pretends to have loaded is
