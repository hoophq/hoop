// Package sidecar turns raw database wire-protocol bytes into structured
...
var ErrUnsupportedProtocol = errors.New("sidecar: unsupported protocol")
...
var ErrBufferOverflow = errors.New("sidecar: message exceeds max buffer")
