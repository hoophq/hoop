...
c_step "Ready"
cat <<'EOF'
  Verify:      sidecar/scripts/dev/mssql2019-check.sh
  A session:   sidecar/scripts/dev/mssql2019-stack.sh sql
  Audit API:   curl -s localhost:19001/api/sessions | jq
  Tear down:   sidecar/scripts/dev/mssql2019-stack.sh down
