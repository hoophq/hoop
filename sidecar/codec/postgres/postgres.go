// Package postgres registers the Postgres codec with the inspect registry.
//
...
//
//	import _ "github.com/hoophq/hoop/sidecar/codec/postgres"
//
...
// New builds a Postgres codec wired to sidecar's classifier and lexer.
//
