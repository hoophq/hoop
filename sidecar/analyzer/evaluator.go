...
func New(cfg Config) (*Evaluator, error) {
	if cfg.Provider == nil {
		return nil, fmt.Errorf("sidecar/analyzer: no provider configured")
	}
	if cfg.Rule == "" {
...
func (e *Evaluator) Evaluate(stmt inspect.Statement) policy.Verdict {
...
func (e *Evaluator) EvaluateWith(stmt inspect.Statement, ec *policy.EvalContext) policy.Verdict {
...
func (e *Evaluator) wanted(stmt inspect.Statement, ec *policy.EvalContext) bool {
