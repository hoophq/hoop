...
type Builder interface {
	...
	Build(stmt inspect.Statement, maxBytes int) (Content, bool)
}

// ErrUnknownProvider is returned by NewProvider for an unregistered name.
var ErrUnknownProvider = errors.New("sidecar/analyzer: unknown provider")
...
// collide with it.
const RefuseSentinel = "\x00sidecar:refuse\x00"
