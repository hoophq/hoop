...
export default function AIDataMaskingSection() {
  ...
  // Mirrors CLJS disabled? predicate exactly: disabled for free license,
  // when gateway has no redact credentials configured, or when the
  // provider is mspresidio (which is now managed via the dedicated AI
  // Data Masking page rather than per-connection).
  const disabled =
    isFreeLicense || !hasRedactCredentials || redactProvider === 'mspresidio'
