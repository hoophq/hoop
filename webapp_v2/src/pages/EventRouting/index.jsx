...
export default function EventRouting() {
  ...
  const loading = subscriptions.status === 'loading' || catalog.status === 'loading'
        ...
        <Group justify="space-between" align="flex-start">
          <Stack gap="sm">
            <Group gap="sm" align="center">
              ...
              <Badge color="green" variant="filled" size="sm">NEW</Badge>
            </Group>
            <Text size="md" c="dimmed">
              Route platform events to runbooks. Each subscription becomes an audited automation surface.
            </Text>
          </Stack>
