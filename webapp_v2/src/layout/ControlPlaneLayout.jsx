...
import Sidebar from './Sidebar/ControlPlaneSidebar';
import AppHeader from './Header/ControlPlaneHeader';
import LicenseBanner from './LicenseBanner';
import { SkipLink } from './SkipLink';
import ControlPlaneCommandPalette from '@/features/CommandPalette/ControlPlaneCommandPalette';

// The control plane shell, sibling of GatewayLayout.jsx: the same geometry, its
// own Sidebar and Header, no Native Connections drawer (the control plane starts
// no data plane to connect to), and the palette mounted here because no route
// of this product is ClojureScript.
...
function ControlPlaneLayout({ children }) {
