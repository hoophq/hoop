...
// them to the Gate. Those codecs ship in github.com/hoophq/libhoop, a private
// module, so the dependency lives here rather than in the root
// github.com/hoophq/hoop/hoopinspect module, which stays at zero dependencies
// and stays buildable without credentials.
//
