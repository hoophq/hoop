...
// dependency runs the other way — hoopinspect and the hoop gateway both
...
// message. The alternative — hoopinspect declaring its own structs and
...
//
// These names are hoopinspect's public API. Changing one means changing
