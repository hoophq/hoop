...
func TestDecidePhaseSendsWhatProducersFound(t *testing.T) {
	...
	v := c.EvaluateWith(stmt("DELETE FROM customers", hoopinspect.OpDelete, "customers"), producedContext(
		policy.Finding{
...
func TestDegradedFindingTravelsWithNoValues(t *testing.T) {
	for _, tc := range []struct{ status, reason string }{
		...
		t.Run(tc.status, func(t *testing.T) {
			...
			c.EvaluateWith(stmt("DELETE FROM t", hoopinspect.OpDelete, "t"), producedContext(
...
func TestNoProducerMeansNoFindingsField(t *testing.T) {
	...
	c.EvaluateWith(stmt("SELECT 1", hoopinspect.OpSelect), producedContext())
...
func TestSinglePhaseInputIsUnchanged(t *testing.T) {
	...
	c.Evaluate(stmt("SELECT 1", hoopinspect.OpSelect))
...
func TestGatePhaseRequestsAProducer(t *testing.T) {
	...
	if v := c.EvaluateWith(stmt("SELECT * FROM customers", hoopinspect.OpSelect, "customers"), &ec); v.Denied {
...
func TestGateVetoIsNotSilence(t *testing.T) {
	...
	var ec policy.EvalContext
	c.EvaluateWith(stmt("SELECT 1", hoopinspect.OpSelect), &ec)
...
func TestGateRequestSurvivesAGateDenial(t *testing.T) {
	...
	var ec policy.EvalContext
	if v := c.EvaluateWith(stmt("DELETE FROM t", hoopinspect.OpDelete, "t"), &ec); !v.Denied {
...
func TestUndefinedGateDecisionAllows(t *testing.T) {
	...
	var ec policy.EvalContext
	if v := c.EvaluateWith(stmt("SELECT 1", hoopinspect.OpSelect), &ec); v.Denied {
...
func TestUndefinedDecideDecisionStillDenies(t *testing.T) {
	...
	if v := c.EvaluateWith(stmt("DELETE FROM t", hoopinspect.OpDelete, "t"), producedContext()); !v.Denied {
...
func (c *contextEvaluator) Evaluate(hoopinspect.Statement) policy.Verdict {
	return policy.Verdict{Annotations: c.notes}
}

func (c *contextEvaluator) EvaluateWith(_ hoopinspect.Statement, ec *policy.EvalContext) policy.Verdict {
...
func TestChainThreadsFindingsForward(t *testing.T) {
	...
	policy.Chain{first, second}.Evaluate(stmt("DELETE FROM t", hoopinspect.OpDelete, "t"))
...
func TestLaterEvaluatorSeesTheHighestRiskPair(t *testing.T) {
	...
	policy.Chain{loud, quiet, last}.Evaluate(stmt("SELECT 1", hoopinspect.OpSelect))
...
func TestChainThreadsTheGateRequestForward(t *testing.T) {
	...
	policy.Chain{gate, producer}.Evaluate(stmt("SELECT 1", hoopinspect.OpSelect))
