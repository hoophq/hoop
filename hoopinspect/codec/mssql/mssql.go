// Package mssql registers the MSSQL codec with hoopinspect.
//
...
//
//	import _ "github.com/hoophq/hoop/hoopinspect/codec/mssql"
package mssql
...
// New builds an MSSQL codec wired to hoopinspect's classifier.
//
...
func New() hoopinspect.Codec {
	return codecmssql.New(codecmssql.Options{Analyze: hoopinspect.AnalyzeSQL})
}
