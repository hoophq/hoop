...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/openapi.PaginatedResponse-openapi_Attributes"
                        }
                    },
                    "422": {
                        "description": "Unprocessable Entity",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/openapi.AttributeRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/openapi.Attributes"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/integrations/aws/rds/credentials": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/openapi.CreateRdsRootPasswordRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/openapi.CreateRdsRootPasswordResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 50,
                        "description": "Limit number of frames",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/sessionapi.RDPFramesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "openapi.Attributes": {
            ...
            "properties": {
                ...
                "connection_names": {
                    "description": "Connection names associated with this attribute",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
                ...
                "datamasking_rule_names": {
                    "description": "Datamasking rule names associated with this attribute",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
                ...
                "org_id": {
                    "description": "Organization ID that owns this attribute",
                    "type": "string",
                    "format": "uuid",
                    "readOnly": true,
        ...
        "openapi.CreateRdsRootPasswordCredentialsInfo": {
            "type": "object",
            "properties": {
                "expire_at": {
                    "description": "The time when this password will expire, another random password will be generated after this time and this password will no longer work.",
                    "type": "string",
                    "example": "2025-02-28T12:34:56Z"
                },
                "password": {
                    "description": "The random password generated for the instance.",
                    "type": "string",
        ...
        "openapi.CreateRdsRootPasswordRequest": {
            ...
            "properties": {
                "instances": {
                    "description": "the instance arn id to generate credentials for",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
        ...
        "openapi.CreateRdsRootPasswordResponse": {
            ...
            "properties": {
                "credentials": {
                    "description": "The passwords generated by each instance",
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/openapi.CreateRdsRootPasswordCredentialsInfo"
                    }
                }
            }
        },
        ...
        "openapi.PaginatedResponse-openapi_Attributes": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "openapi.ResourceApplyResult": {
            ...
            "properties": {
                "message": {
                    "description": "Contains any internal error that happened during the process of applying the migration",
                    "type": "string",
                    "example": "failed executing command"
                },
                "resource_name": {
        ...
        "openapi.ResourcePlanItem": {
            ...
            "properties": {
                "privileges": {
                    "description": "The list of privileges to plan granting",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
                ...
                "role": {
                    "description": "The role to plan provisioning for (e.g., \"ro\", \"rw\")",
                    "type": "string",
                    "example": "ro"
                },
                "rotate_password": {
                    "description": "Force a password rotation",
                    "type": "boolean",
                    "example": true
                },
                "scopes": {
                    "description": "The list of database and schemas to apply privileges to, formatted as \"database\" or \"database.schema\".\nIn case the schema is omitted, privileges will be applied default schema based on the database type.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
                ...
                "source_role": {
                    "description": "The source role to inherits permissions, it must exists in the instance",
                    "type": "string",
                    "example": "pg_read_all_data"
                },
                "type": {
                    "description": "Type of management of the role, either \"managed\" or \"external\". Defaults to managed",
                    "type": "string",
                    "enum": [
                        "managed",
                        "external"
        ...
        "openapi.ResourcePlanResult": {
            ...
            "properties": {
                "message": {
                    "description": "Output message from the execution",
                    "type": "string",
                    "example": "1\n(1 row)"
                },
                "resource_name": {
                ...
                "role": {
                    "description": "The role this plan result is for",
                    "type": "string",
                    "example": "ro"
                },
                "sid": {
        ...
        "sessionapi.RDPFramesResponse": {
            "type": "object",
            "properties": {
                "frames": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/sessionapi.RDPFrame"
                    }
                },
                "has_more": {
                    "type": "boolean"
