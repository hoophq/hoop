...
func TestControlPlaneRoutes(t *testing.T) {
	...
	want := []string{
		...
		"GET /api/sidecars",
		"GET /api/sidecars/:nameOrID",
		"GET /api/sidecars/configuration",
		"GET /api/userinfo",
		"GET /api/users",
		...
		"HEAD /api/sidecars",
		"HEAD /api/sidecars/:nameOrID",
		"HEAD /api/sidecars/configuration",
		"HEAD /api/userinfo",
		"HEAD /api/users",
