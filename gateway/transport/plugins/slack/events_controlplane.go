...
const (
	...
	cpNoUserMsgFormat    = "No Hoop user has the email %s. Log in to Hoop once, or ask an admin to add you on the Users page."
...
// user names them. Their groups are the hoop user's, which each login syncs
